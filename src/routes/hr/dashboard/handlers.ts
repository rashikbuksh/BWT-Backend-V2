...
import type { GetAttendanceReportRoute, GetDailyEmployeeAttendanceReportRoute, GetEmployeeAttendanceReportRoute, GetMonthlyAttendanceReportRoute } from './routes';
