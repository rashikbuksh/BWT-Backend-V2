---------------- inserted----------------------
-- CREATE OR REPLACE FUNCTION affiliate_after_product_variant_update_function() RETURNS TRIGGER AS $$ BEGIN -- Update affiliates that reference this product_variant with the l
...
-- AFTER
-- UPDATE ON store.product_variant FOR EACH ROW EXECUTE FUNCTION affiliate_after_product_variant_update_function();


CREATE OR REPLACE FUNCTION product_variant_after_affiliate_update_function() RETURNS TRIGGER AS $$ BEGIN
